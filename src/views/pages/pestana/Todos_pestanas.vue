<template>
  <div>
    <div class="row justify-content-between mb-3">   
      <div class="col-6">
        <h1 class="h3 mb-0">Pestañas y Columnas</h1> 
      </div>
      <div class="col-6 text-right">
        <router-link to="/protocolos/crear-pestanas" tag="button" class="btn btn-primary">Crear Pestañas</router-link>
      </div>    
    </div>
    <div class="row">
      <div class="col-12">
              ...
              <ul class="list-group">
                <li class="list-group-item d-flex justify-content-between">
                  <div class="list-group-item-head ">
                    <!--<a href="#" class="">Protocolo active</a>-->
                    <router-link to="/protocolos/crear-protocolos"  class="">Pestana</router-link>                  
                  </div> 
                  <div class="protocolo">
                    Protocolo 1
                  </div>
